    ...
    return (
        ...
        <div className="page-LanHa">
            ...
            <div className="album py-5 bg-body-tertiary">
                            ...
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet card-ChiTiet">
                                        <h5 className="card-text card-NameShip card-NameShip">Du thuyền Indochine</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 20 phòng</p>
                                        <div className="Gia-mua">
                                            <p className="Gia-tien">3,550,000đ / khách</p>
                                            <button className="btn btn-info rounded-pill px-3 btn-Datmua" type="button">Đặt mua</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet">
                                        <h5 className="card-text card-NameShip">Du thuyền Aqua of the seas</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2023 - Tàu vỏ kim loại - 27 phòng</p>
                                        <div className="Gia-mua">
                        ...
                        <div className="col">
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet">
                                        <h5 className="card-text card-NameShip">Du thuyền La Casta Daily</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2022 - Tàu vỏ kim loại - 10 phòng</p>
                                        <div className="Gia-mua">
                        ...
                        <div className="col">
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet">
                                        <h5 className="card-text card-NameShip">Du thuyền Verdure Lotus</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 15 phòng</p>
                                        <div className="Gia-mua">
                        ...
                        <div className="col">
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet">
                                        <h5 className="card-text card-NameShip">Du thuyền Sea Octopus</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2022 - Tàu vỏ kim loại - 18 phòng</p>
                                        <div className="Gia-mua">
                        ...
                        <div className="col">
                            <div className="card shadow-sm ship">
                                <div className="Khung-anh">
                                    ...
                                    <div className="card-body card-ChiTiet">
                                        <h5 className="card-text card-NameShip">Du thuyền Genesis Regal</h5>
                                        <p className="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 18 phòng</p>
                                        <div className="Gia-mua">
                                            <p className="Gia-tien">3,000,000đ / khách</p>
                                            <button className="btn btn-info rounded-pill px-3 btn-Datmua btn-Datmua" type="button">Đặt mua</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <button className="btn btn-outline-secondary d-inline-flex align-items-center text-align-center btn-Xemthem" type="button"> Xem thêm thuyền </button>
            </div>
