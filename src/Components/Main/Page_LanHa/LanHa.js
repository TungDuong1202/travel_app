...
const LanHa = () => {
    return (
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 20 phòng</p>
                                    <div class="Gia-mua">
                                        <p class="Gia-tien">3,550,000đ / khách</p>
                                        <button class=" btn-info rounded-pill px-3" type="button">Đặt mua</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2023 - Tàu vỏ kim loại - 27 phòng</p>
                                    <div class="Gia-mua">
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2022 - Tàu vỏ kim loại - 10 phòng</p>
                                    <div class="Gia-mua">
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 15 phòng</p>
                                    <div class="Gia-mua">
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2022 - Tàu vỏ kim loại - 18 phòng</p>
                                    <div class="Gia-mua">
                        ...
                        <div class="card shadow-sm">
                            <div class="khung">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="thong-tin"> <FaShip /> - Hạ thuỷ 2019 - Tàu vỏ kim loại - 18 phòng</p>
                                    <div class="Gia-mua">
        ...
        <button class="btn btn-outline-secondary d-inline-flex align-items-center text-align-center" type="button"> Xem thêm thuyền </button>
        </>
    );
};
