              ...
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group list-group-horizontal">
                    <li class="list-group-item"><GiBigWave /> Hạ thủy 2019</li>
                    <li class="list-group-item"><IoMdBoat /> Tàu vỏ kim loại</li>
                    <li class="list-group-item"><MdOutlineBedroomParent /> 20 phòng</li>
                    <li class="list-group-item price-and-button">
                      <b><MdAttachMoney/> 3,550,000đ/ 1 khách</b>
